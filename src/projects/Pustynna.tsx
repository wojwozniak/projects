  ...
  return (
    <ProjectComponent
      ...
      description={
        <div>
          <p>
            This is the first semi-professional project and the first "big" website. I have used HTML, CSS, Javascript and PHP to create it. I have also used Wordpress as a CMS. I still help with website maintenance and develop new features (such as seasonal mini-games).
          </p>
